...
const CACHE_NAME = 'dulunopy-vmu35sppf';
...
const PRECACHE_ASSETS = [
  './assets/ui-shell.min.js?v=vmu35sppf',
  './assets/charts-workspace.min.js?v=vmu35sppf',
  './assets/weather-workspace.min.js?v=vmu35sppf',
  './assets/info-workspace.min.js?v=vmu35sppf',
  './assets/study-tools.min.js?v=vmu35sppf',
  './assets/route-insights.min.js?v=vmu35sppf',
  './assets/scenarios.min.js?v=vmu35sppf',
  './',
  './index.html',
  ...
  './assets/app.min.css?v=vmu35sppf',
  './assets/integrity.min.js?v=vmu35sppf',
  './assets/app.min.js?v=vmu35sppf',
  './assets/haven-features.min.js?v=vmu35sppf'
];
